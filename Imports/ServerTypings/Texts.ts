    ...
    declare namespace Db {
        ...
        namespace Siswa {
            ...
            namespace Kelas {
                ...
                export const IdJurusanNamaJurusan: string;
                export const NamaKelas: string;
                export const SiswaDetailList: string;
                export const Tingkat: string;
            }

            namespace Kelassiswa {
                export const Id: string;
                export const KelasId: string;
                export const KelasIdJurusan: string;
                export const KelasNamaKelas: string;
                export const KelasTingkat: string;
                export const SiswaAlamat: string;
                export const SiswaId: string;
                export const SiswaJenisKelamin: string;
                export const SiswaKotaId: string;

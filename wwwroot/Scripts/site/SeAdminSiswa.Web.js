        ...
        var SiswaGrid = /** @class */ (function (_super) {
            ...
            SiswaGrid.prototype.getColumns = function () {
                ...
                columns.push({
                    field: 'Del Row',
                    name: '',
                    format: function (_ctx) { return '<a class="inline-action delete-row" title="delete" href="javascript:;"> <i class="fa fa-trash-o inline-action delete-row text-red"></i> </a>'; },
                    width: 15,
                    minWidth: 15,
                    maxWidth: 15
                });
